...
function wrapSelection(selection, selector) {
  ...
  if (!wrapped.size()) {
    ...
    var tag = _selector$split2[0];
    var className = _selector$split2[1];
...
var x = function x(d) {
  ...
  return +d.v;
    ...
    plot = (0, _d3Axes.axes)((0, _d3Compose.compose)(_d3Axes.axesPositionBottom, xAxis), (0, _d3Compose.compose)(function (selection) {
...
(0, _d3Request.csv)("data.csv", function (error, data) {
  if (!data) throw error;

  plot.domain((0, _d3Array.extent)(data, x), (0, _d3Array.extent)(data, y));

  var curves = svg.transition().duration(900).call(plot).select('.axes').selectAll('.curve').selection().data([data]);
...
},{"d3-array":2,"d3-axes":3,"d3-axis":4,"d3-compose":5,"d3-request":6,"d3-scale":10,"d3-selection":17,"d3-shape":18,"d3-transition":20,"d3-wrap":26}],2:[function(require,module,exports){
...
},{"d3-collection":7,"d3-dispatch":8,"d3-dsv":9}],7:[function(require,module,exports){
...
},{"d3-array":2,"d3-collection":11,"d3-color":12,"d3-format":13,"d3-interpolate":14,"d3-time":16,"d3-time-format":15}],11:[function(require,module,exports){
...
},{"d3-path":19}],19:[function(require,module,exports){
...
},{"d3-color":21,"d3-dispatch":22,"d3-ease":23,"d3-interpolate":24,"d3-selection":17,"d3-timer":25}],21:[function(require,module,exports){
...
},{"d3-color":21,"dup":14}],25:[function(require,module,exports){
